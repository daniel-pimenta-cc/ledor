...
const I18N = {
  pt: {
    ...
    'hero.lead': 'Uma palavra de cada vez, no ritmo que você escolher, com a letra de foco sempre no mesmo lugar. Seus olhos param de correr atrás do texto, a distração some e a velocidade sobe sem esforço. Aperte o play aí do lado.',
    ...
    'sync.li2': 'Sincroniza biblioteca, progresso por livro, marcadores, avaliações, sessões de leitura e configurações de exibição.',
    ...
    'stats.lead': 'Quantas palavras você leu esta semana? Em que velocidade? O Ledor registra cada sessão e transforma sua leitura em gráficos da semana e do mês. E no fim do mês ainda sai uma retrospectiva pronta pra compartilhar.',
  ...
  en: {
    ...
    'hero.lead': "One word at a time, at the pace you choose, with the focus letter always in the same spot. Your eyes stop chasing the text, distractions fade and speed climbs on its own. Press play, it's right there.",
